...
@section('main-content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{route('forms')}}" class="btn btn-primary float-end mb-3">Forms <i class="bx bx-task"></i> </a>
        </div>
        <div class="card-body" style="padding: 2px;">
            <div class="row">
                <div class="col-md-12 mt-4">
                    <div class="h4 text-center">Edit Form Details</div>
                    <div class="container">
                        <form action="">
                            @csrf
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="formName" value="{{$form->form_name ?? '' }}" id="formName" placeholder="Form Name"  class="form-control">
                                ...
                                <div class="form-group mb-3 d-flex justify-content-center">
                                    ...
                                    <button type="submit" id="saveForm" class="btn btn-primary">Save changes <i class="bx bx-right-arrow"></i> </button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@section('extra-scripts')
    ...
    <script>
        $(document).ready(function(){
            const fields = `{!! json_encode($form->structure, true) !!}`;
            const options = {
                formData: fields,
                dataType: "json",
