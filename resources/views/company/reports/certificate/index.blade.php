    ...
    <div class="container-fluid">
        <div class="row">
            @if($search == 0)
                ...
                @endif
                @include('company.reports.certificate._search-form')
            @else
                @include('company.reports.certificate._search-form')
                <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title"> Certificate/License Report</h4>
                                    <!-- Nav tabs -->
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12 col-lg-12">
                                                    ...
                                                    @endif
                                                        ...
                                                        <p class="text-center">Showing certificate/license report between <code>{{date('d M, Y', strtotime($from))}}</code> to <code>{{date('d M, Y', strtotime($to))}}</code></p>
                                                                            ...
                                                                            <td>
                                                                                <div class="btn-group">
                                                                                    ...
                                                                                    <div class="dropdown-menu">
                                                                                        <a class="dropdown-item" target="_blank" href="{{ route('certificate-details', $cert->slug) }}" > <i class="bx bxs-book-open"></i> View</a>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
