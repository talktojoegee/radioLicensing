                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Cash Inflow</h4>
                                <!-- Nav tabs -->
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row mb-1">
                                                            <div class="col">
                                                                ...
                                                                <h5 class="mb-0 number-font">{{env('APP_CURRENCY')}}{{number_format($income->sum('cashbook_credit'),2)}}</h5>
                                                            </div>
                                                        ...
                                                        <span class="text-muted fs-12 ms-0 mt-1">Income </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xxl-3 col-sm-6">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row mb-1">
                                                            <div class="col">
                                                                <p class="mb-2">Income</p>
                                                                <h5 class="mb-0 number-font">{{env('APP_CURRENCY')}}{{number_format($thisWeek->sum('cashbook_credit'),2)}}</h5>
                                                            </div>
                                                            <div class="col-auto mb-0">
                                                        ...
                                                        <table id="datatable1" class="table table-bordered dt-responsive  nowrap w-100">
                                                            ...
                                                            @foreach($fxIncomes as $fx)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: right;">{{ $fx->getCurrency->code ?? '' }} - {{ $fx->getCurrency->symbol ?? '' }}{{number_format($fx->cashbook_credit ?? 0,2)}}</td>
                                                                    <td>
