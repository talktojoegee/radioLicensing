...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="card">
                    <div class="card-header bg-primary text-white">Create A Website Leads Form</div>
                    <div class="card-body">
                           ...
                           <form action="{{route('create-website-form')}}" method="post">
                               ...
                               <div class="col-md-6">
                                   <div class="form-group">
                                       ...
                                       <input type="text" placeholder="Form Title" name="formTitle" value="{{old('formTitle')}}" class="form-control">
                                       @error('formTitle') <i class="text-danger">{{$message}}</i> @enderror
                                       <div class="form-check form-check-primary mb-3">
                                           <input name="showTitle" class="form-check-input" type="checkbox"  checked>
                                   ...
                                   <div class="form-group mt-3">
                                       ...
                                       <textarea name="formDescription" style="resize: none;" placeholder="Type form description here..." class="form-control">{{old('formDescription')}}</textarea>
                                   </div>
                                   <div class="form-group mt-4">
                                       <h5>Button Text</h5>
                                       <input type="text" name="buttonText" value="{{old('buttonText')}}" placeholder="Get in Touch" class="form-control">
                                       @error('buttonText') <i class="text-danger">{{$message}}</i> @enderror
                                   </div>
                                   <div class="form-group mt-4">
                                       <h5>Thank You Message</h5>
                                       <p>Show after form is submitted.</p>
                                       <textarea name="thankYouMessage" style="resize: none;" placeholder="Type your thank you message here..." class="form-control">{{old('thankYouMessage')}}</textarea>
                               ...
                               <div class="form-group d-flex justify-content-center mt-3">
                                   <button class="btn btn-primary btn-rounded waves-effect waves-light">Save Form</button>
                               </div>
                               </div>
                           </form>
