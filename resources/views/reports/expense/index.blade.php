    ...
    <div class="container-fluid">
        <div class="row">
            @if($search == 0)
                ...
                @endif
                @include('reports.expense._search-form')
            @else
                @include('reports.expense._search-form')
                                                    ...
                                                    @endif
                                                        ...
                                                        <div class="table-responsive mt-3">
                                                            <table id="complex-header" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="complex-header_info" style="width: 100%; margin:0px auto;">
                                                                ...
                                                                <tbody>
                                                                @php $serial = 1; @endphp
                                                                @foreach($transactions->where('cashbook_debit', '>', 0)->where('cashbook_currency_id', $defaultCurrency->id) as $item =>$trans)
                                                ...
                                                <form action="#" method="#">
                                                    ...
                                                    <div class="table-responsive mt-3">
                                                        <table id="complex-header" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="complex-header_info" style="width: 100%; margin:0px auto;">
                                                            ...
                                                            <tbody>
                                                            @php $index = 1; @endphp
                                                            @foreach($transactions->where('cashbook_debit', '>', 0)->where('cashbook_currency_id','!=', $defaultCurrency->id) as $item=>$fx)
                                                                <tr role="row" class="odd bg-secondary text-white ">
