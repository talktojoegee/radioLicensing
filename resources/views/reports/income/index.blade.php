    ...
    <div class="container-fluid">
        <div class="row">
            @if($search == 0)
                ...
                @endif
                @include('reports.income._search-form')
            @else
                @include('reports.income._search-form')
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12 col-lg-12">
                                                    ...
                                                    @endif
                                                        ...
                                                        <p class="text-center">Showing income report between <code>{{date('d M, Y', strtotime($from))}}</code> to <code>{{date('d M, Y', strtotime($to))}}</code></p>
                                                ...
                                                <form action="#" method="#">
                                                    ...
                                                    <div class="table-responsive mt-3">
                                                        <table id="complex-header" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="complex-header_info" style="width: 100%; margin:0px auto;">
                                                            ...
                                                            <tbody>
                                                            @php $index = 1; @endphp
                                                            @foreach($transactions->where('cashbook_credit', '>', 0)->where('cashbook_currency_id','!=', $defaultCurrency->id) as $item=>$fx)
                                                                <tr role="row" class="odd bg-secondary text-white ">
