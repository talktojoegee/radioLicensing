    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-xxl-12 col-sm-12">
                <p>Use the form below to generate <code>client</code> report.</p>
            </div>
            <div class="col-xxl-4 col-md-4 col-sm-4">
                <div class="card">
                    <div class="card-header bg-primary text-white">Generate Client Report</div>
                    <div class="card-header m-4">
                        <form action="{{route('filter-practitioner-report')}}" class="" method="get">
                            @csrf
                            <div class="form-group mt-3">
                                <label for="" class="text-muted">Client</label>
